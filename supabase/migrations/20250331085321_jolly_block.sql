...
-- Create improved function with proper subscription cleanup
...
BEGIN
  ...
  -- Start transaction
  BEGIN
    -- First delete all canceled subscriptions for this user
    DELETE FROM subscriptions
    WHERE user_id = p_user_id
      AND status = 'canceled';

    -- Then cancel any existing active subscription
