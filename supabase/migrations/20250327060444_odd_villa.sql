/*
  ...
  1. Changes
    - Add proper RLS policies for admin access to all tables
    - Ensure admin user can access all necessary data
    - Fix permission issues for metrics, orders, and subscriptions
...
-- Add comprehensive policies for pedidosxmenu
