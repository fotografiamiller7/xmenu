/*
  # Fix subscription constraint handling

  1. Changes
    - Drop existing unique constraint that prevents multiple active subscriptions
    - Add new function to properly handle subscription transitions
    - Ensure proper status changes for subscriptions
...
-- Create improved function that properly handles subscription transitions
