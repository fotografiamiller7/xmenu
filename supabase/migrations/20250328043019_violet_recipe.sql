/*
  # Fix subscription period handling and expiration dates

  1. Changes
    - Update sync_subscription_with_profile function to properly handle annual subscriptions
    - Add period_type validation
    - Fix expiration date calculation
    - Add trigger to sync subscription payments with subscriptions
