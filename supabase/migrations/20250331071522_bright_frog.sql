/*
  ...
  1. Changes
    - Add payment status check to manage_subscription_transition function
    - Add validation for payment status before updating subscription
...
-- Create improved function with payment status check
